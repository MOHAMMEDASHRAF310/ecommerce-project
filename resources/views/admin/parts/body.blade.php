              ...
              <div class="row">
                <div class="col-8 col-sm-12 col-xl-8 my-auto">
                  <div class="d-flex d-sm-block d-md-flex align-items-center">
                    <h2 class="text-success ml-2 mb-0 font-weight-medium">{{count($datas)}}  Order</h2>
                  </div>
                </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <span class="pl-2">{{$item->fname}} {{$item->lname}}</span>
                      </td>
                      <td> {{$item->phone}} </td>
                      ...
                      <td>
                        <select name="" id="" class="btn btn-primary">
                          <option value="Approved" class="badge badge-outline-success">Approved</option>
                          <option value="Approved" class="badge badge-outline-danger">Rejectted</option>
                          <option value="Approved" class="badge badge-outline-warning">Panding</option>
                        </select>
                      </td>
                    </tr>
                    @endforeach
